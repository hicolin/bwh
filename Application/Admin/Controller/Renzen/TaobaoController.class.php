 ...
 */
 ...
 class TaobaoController extends BaseController{
     ...
     public function detail(){
        $ID=I('request.ID');
        if($ID){
            $infos=M('renzen_taobao')->alias('a')
                   ->field('a.ID,a.BDMobile,a.Levels,a.Balance,a.JBalance,a.UserName,a.XFQuote,a.XYQuote,a.ZmScore,a.JieBei,a.YZStatus,a.RenzTime,a.Status,b.Mobile,b.TrueName')
